        ...
        <div className="container max-w-6xl relative py-14 md:py-20">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <p className="text-base md:text-lg text-muted-foreground mt-6 max-w-lg">
              ...
              <form
                ...
                className="mt-8 flex items-center gap-2 p-1.5 pl-4 rounded-full bg-card border border-border/70 shadow-soft max-w-md focus-within:border-primary/50 focus-within:shadow-brand transition-all"
              >
                <input
                  type="email"
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <Button size="lg" variant="ghost" asChild className="text-sm font-semibold">
            ...
            <div className="relative min-h-[480px] lg:min-h-[560px] flex items-center justify-center">
              {/* Soft blob backdrop */}
              <div className="absolute inset-6 rounded-[3rem] bg-gradient-to-br from-primary/15 via-primary-glow/10 to-accent/20 blur-2xl" />
              <div className="absolute inset-8 rounded-[2.5rem] bg-gradient-to-br from-primary/10 to-accent/10" />

              {/* Portrait */}
              <div className="relative z-10 h-[440px] md:h-[520px] rounded-[2.5rem] overflow-hidden ring-1 ring-border/60 shadow-[0_30px_80px_-20px_hsl(var(--primary)/0.35)] w-[85%] max-w-md">
                <img
                  src={heroFounder}
              ...
              <div className="hidden sm:flex absolute top-4 right-0 md:right-4 z-20 items-center gap-3 rounded-2xl bg-card/95 backdrop-blur border border-border/70 shadow-lg p-3 pr-4 animate-float-slow">
                <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-primary/15 to-accent/15 flex items-center justify-center">
                  <img src={badgeAnalytics} alt="" className="h-8 w-8 object-contain" loading="lazy" />
                </div>
                <div>
              ...
              <div className="hidden sm:flex absolute top-1/3 left-0 md:-left-4 z-20 items-center gap-3 rounded-2xl bg-card/95 backdrop-blur border border-border/70 shadow-lg p-3 pr-4 animate-float-slow" style={{ animationDelay: "1.2s" }}>
                <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-accent/20 to-primary-glow/20 flex items-center justify-center">
                  <img src={badgeStore} alt="" className="h-8 w-8 object-contain" loading="lazy" />
                </div>
                <div>
                  <div className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Live store</div>
                  <div className="text-sm font-bold text-foreground">Launched in 36h</div>
                </div>
              </div>

              {/* Floating card — Reviewer profile (bottom) */}
              <div className="absolute bottom-2 left-2 md:left-8 z-20 flex items-center gap-3 rounded-2xl bg-card/95 backdrop-blur border border-border/70 shadow-lg p-3 pr-5 animate-float-slow" style={{ animationDelay: "2.4s" }}>
                <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-primary-foreground text-xs font-bold">
                  AR
                </div>
                <div>
                  <div className="text-sm font-bold text-foreground leading-tight">Ayesha Raza</div>
              ...
              <div className="hidden md:flex absolute bottom-8 right-0 z-20 flex-col rounded-2xl bg-card/95 backdrop-blur border border-border/70 shadow-lg px-4 py-3 animate-float-slow" style={{ animationDelay: "1.8s" }}>
                ...
                <div className="text-[10px] text-muted-foreground">From 1,200+ reviews</div>
              </div>
            </div>
          </div>
        </div>
