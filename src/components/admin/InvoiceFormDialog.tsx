...
import { Invoice, InvoiceItem, useCreateInvoice, useUpdateInvoice } from "@/hooks/useInvoices";
...
export function InvoiceFormDialog({ open, onOpenChange, invoice, order }: InvoiceFormDialogProps) {
